    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/nodir_khajiev">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://www.github.com/nodirhajiev"><i class="fab fa-github"></i></a>
        <a href="https://t.me/nodir_khajiev"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
